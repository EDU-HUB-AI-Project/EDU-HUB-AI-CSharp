namespace EDU_HUB_AI.Config.Theme
{
    ...
    {
        private static readonly FontFamily Base = SystemFonts.MessageBoxFont.FontFamily;
        ...
        public static Font NavItem => new(Base, 9f, FontStyle.Regular);
        public static Font NavGroup => new(Base, 8.25f, FontStyle.Regular);
